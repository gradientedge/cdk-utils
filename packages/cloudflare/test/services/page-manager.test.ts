  ...
  test('provisions pages project as expected', () => {
    pulumi
      ...
      .apply(([id, urn, accountId, name, productionBranch]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::cloudflare:test-common-stack$cloudflare:index/pagesProject:PagesProject::test-pages-project-dev'
        )
  ...
  test('provisions pages project as expected', () => {
    pulumi
      ...
      .apply(([id, urn, accountId, name, productionBranch, buildConfig, deploymentConfigs]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::cloudflare:test-common-stack$cloudflare:index/pagesProject:PagesProject::test-pages-project-with-build-dev'
        )
        expect(accountId).toEqual('123456789012')
  ...
  test('provisions pages domain as expected', () => {
    pulumi
      ...
      .apply(([id, urn, accountId, name, projectName]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::cloudflare:test-common-stack$cloudflare:index/pagesDomain:PagesDomain::test-pages-domain-dev'
        )
        expect(accountId).toEqual('123456789012')
  ...
  test('provisions page rule as expected', () => {
    pulumi
      ...
      .apply(([id, urn, actions, priority, target, zoneId]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::cloudflare:test-common-stack$cloudflare:index/pageRule:PageRule::test-page-rule-dev'
        )
