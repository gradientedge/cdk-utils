...
const testStackProps = {
  ...
  extraContexts: [
    ...
    'packages/aws/test/common/cdk-config/clusters.json',
    'packages/aws/test/common/cdk-config/distributions.json',
    'packages/aws/test/common/cdk-config/fileSystems.json',
    'packages/aws/test/common/cdk-config/healthCheck.json',
    'packages/aws/test/common/cdk-config/logs.json',
    'packages/aws/test/common/cdk-config/tasks.json',
  ...
  protected determineConstructProps(props: cdk.StackProps) {
    return {
      ...
      ...{
        ...
        siteCacheInvalidationDockerFilePath: `packages/aws/test/common/docker`,
