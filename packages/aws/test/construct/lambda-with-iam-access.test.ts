...
import { CommonStack, LambdaWithIamAccess, LambdaWithIamAccessProps } from '../../src/index.js'
...
class TestCommonStack extends CommonStack {
  ...
  protected determineConstructProps(props: cdk.StackProps) {
    return {
      ...
      lambdaSource: new lambda.AssetCode('packages/aws/test/common/nodejs/lib'),
    }
  }
}
...
describe('TestLambdaWithIamAccess - Branch Coverage Tests', () => {
  ...
  test('handles lambda with layer sources', () => {
    const layerContext = {
      ...testStackProps,
      lambdaLayerSources: [new lambda.AssetCode('packages/aws/test/common/nodejs/lib')],
    }
