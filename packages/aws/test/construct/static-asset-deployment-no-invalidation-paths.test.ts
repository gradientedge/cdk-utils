...
import { CommonStack, StaticAssetDeployment, StaticAssetDeploymentProps } from '../../src/index.js'
import { findOneResourceId, ref } from '../../tools/cdk/index.js'
...
class TestCommonStack extends CommonStack {
  ...
  protected determineConstructProps(props: StackProps) {
    return {
      ...
      staticAssetSources: [Source.asset('packages/aws/test/common/resources/')],
...
describe('StaticAssetDeployment No Invalidation Paths', () => {
