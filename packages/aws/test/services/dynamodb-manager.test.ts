...
import { CommonConstruct, CommonStack, CommonStackProps, TableProps, TablePropsV2 } from '../../src/index.js'
...
const testStackProps = {
  ...
  extraContexts: ['packages/aws/test/common/cdk-config/dynamodb.json'],
