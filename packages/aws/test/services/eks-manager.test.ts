...
const testStackProps = {
  ...
  extraContexts: ['packages/aws/test/common/cdk-config/eks.json', 'packages/aws/test/common/cdk-config/vpc.json'],
...
class TestCommonConstruct extends CommonConstruct {
  ...
  constructor(parent: Construct, name: string, props: TestStackProps) {
    ...
    const testImage = this.ecrManager.createDockerImage('test-image', this, 'packages/aws/test/common/docker')
