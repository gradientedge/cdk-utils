...
import { CommonAzureConstruct, CommonAzureStack, CommonAzureStackProps, ResourceGroupProps } from '../../src/index.js'
  ...
  test('provisions resource group as expected', () => {
    pulumi
      ...
      .apply(([id, urn, name, location, tags]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::construct:test-common-stack$azure-native:resources:ResourceGroup::test-resource-group-dev-rg'
        )
