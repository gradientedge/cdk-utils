...
const testStackProps: any = {
  ...
  extraContexts: ['src/test/azure/common/config/dummy.json', 'src/test/azure/common/config/application-insights.json'],
  features: {},
  location: 'eastus',
  ...
  test('provisions application insights as expected', () => {
    pulumi
      ...
      .apply(([id, urn, name, location, applicationType, tags]) => {
        ...
        expect(urn).toEqual(
          'urn:pulumi:stack::project::azure:test-common-stack$azure-native:applicationinsights:Component::test-application-insights-dev-ai'
        )
