...
const baseExtraContexts = ['src/test/azure/common/config/dummy.json', 'src/test/azure/common/config/rest-api.json']
...
const testStackPropsNewApi: TestAzureStackProps = {
  ...testStackProps,
  extraContexts: ['src/test/azure/common/config/dummy.json', 'src/test/azure/common/config/rest-api-new.json'],
}
...
const testStackPropsNewApiWithCert: TestAzureStackProps = {
  ...
  extraContexts: [
    ...
    'src/test/azure/common/config/rest-api-new-with-cert.json',
  ],
}

const testStackPropsNoInsights: TestAzureStackProps = {
  ...testStackProps,
  extraContexts: ['src/test/azure/common/config/dummy.json', 'src/test/azure/common/config/rest-api-no-insights.json'],
}
